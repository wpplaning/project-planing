...
const Add = ({ projects, setProjects, setIsAdding, getProjects }) => {
  // State for tracking the selected district and subdistrict
  ...
  const [officer, setSelectedOfficer] = useState("");
  ...
  const [proporsal, setSelectedProporsal] = useState("");
